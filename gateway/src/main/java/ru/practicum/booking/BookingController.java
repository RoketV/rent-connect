...
//        return ResponseEntity.ok(bookingClient.getBookingsByBooker(bookerId, state, params));
//    }
//
//    @GetMapping("/owner")
...
//                                                                               defaultValue = "ALL") String state,
//                                                                       @Valid BookingPaginationParams params) {
//        return ResponseEntity.ok(bookingClient.getBookingsByOwner(ownerId, state, params));
//    }
}