...
public class BookingService {
    ...
    public List<BookingResponseDto> getBookingsByBooker(Long bookerId, String state, PaginationParams params) {
    ...
    public List<BookingResponseDto> getBookingsByOwner(Long ownerId, String state, PaginationParams params) {
