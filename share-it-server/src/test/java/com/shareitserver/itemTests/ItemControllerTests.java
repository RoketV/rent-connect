...
import com.shareitserver.item.ItemController;
...
public class ItemControllerTests {
    ...
    public void testGetItems() throws Exception {
        ...
        when(itemService.getItems(eq(1L), any(PaginationParams.class)))
        ...
        verify(itemService, times(1)).getItems(eq(1L), any(PaginationParams.class));
    }
    ...
    public void testSearchItem() throws Exception {
        ...
        when(itemService.searchItem(eq("text"), any(PaginationParams.class))).thenReturn(outputDtoList);
        ...
        verify(itemService).searchItem(eq("text"), any(PaginationParams.class));
    }
