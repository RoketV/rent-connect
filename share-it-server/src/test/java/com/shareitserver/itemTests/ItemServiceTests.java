package com.shareitserver.itemTests;
...
import com.shareitserver.item.ItemService;
...
public class ItemServiceTests {
    ...
    void searchItem_WhenTextIsBlank_ShouldReturnEmptyList() {
        ...
        List<ItemOutputDto> result = itemService.searchItem("", new PaginationParams(1, 20));
    ...
    public void getItem_returnsItemOutputDto() {
        ...
        pastBooking.setBookingState(BookingState.WAITING);
        ...
        futureBooking.setBookingState(BookingState.WAITING);
        ...
        when(bookingRepository.findAllByItem_IdAndBookingState(itemId, BookingState.WAITING)).thenReturn(Arrays.asList(pastBooking, futureBooking));
    ...
    public void testGetItems() {
        ...
        when(itemRepository.findAllByUser_IdOrderByIdAsc(any(), eq(PageRequest.of(params.from(), params.size()))))
