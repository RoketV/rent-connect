...
public class ItemClient extends MainClient {
    ...
    public ResponseEntity<List<ItemOutputDto>> getItems(Long userId, PaginationParams params) {
    ...
    protected ResponseEntity<List<ItemOutputDto>> searchItem(String text, PaginationParams params) {
        ResponseEntity<Object[]> response = searchItemsClient("/search", text, params);
        return responseMaker.makeListResponse(response, ItemOutputDto.class);
    }

    protected ResponseEntity<Object[]> getItemsClient(String path, Long userId, PaginationParams params) {
    ...
    protected ResponseEntity<Object[]> searchItemsClient(String path, String text, PaginationParams params) {
