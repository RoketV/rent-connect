...
public class BookingClient extends MainClient {
    ...
    public ResponseEntity<List<BookingResponseDto>> getBookingsByBooker(Long bookerId, String state, PaginationParams params) {
    ...
    public ResponseEntity<List<BookingResponseDto>> getBookingsByOwner(Long ownerId, String state, PaginationParams params) {
    ...
    protected ResponseEntity<Object[]> getListOfBookings(String path, Long userId, String stateParam, PaginationParams params) {
